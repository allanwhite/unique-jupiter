              ...
              <div className="inner-md outer">
                <div className="post-feed">
                  ...
                  <article key={post_idx} className="post">
                    ...
                    <Link className="post-thumbnail" href={withPrefix(_.get(post, 'stackbit_url_path', null))}><img src={withPrefix(_.get(post, 'thumb_image', null))} alt={_.get(post, 'title', null)} /></Link>
                    )}
                    ...
                    <p className="read-more"><Link href={withPrefix(_.get(post, 'stackbit_url_path', null))} className="read-more-link">Read More</Link></p>
                    </React.Fragment>)}
                  </article>
                ))}
                </div>
