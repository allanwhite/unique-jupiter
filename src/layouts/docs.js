...
export default class Docs extends React.Component {
    render() {
        ...
        let current_page_url = _.trim(_.get(this.props, 'page.stackbit_url_path', null), '/');
        return (
            <Layout {...this.props}>
                  ...
                  <div className="post-inside">
                    ...
                    <div className="post-content">
                      ...
                      {(root_docs_path !== current_page_url) && ((() => {
                          let child_pages = _.orderBy(getPages(this.props.pages, current_page_url), 'weight');
                          ...
                          return (<React.Fragment>
                            {has_children && (
                              <ul className="docs-section-items">
                                ...
                                <li key={child_page_idx} className="docs-section-item"><Link href={withPrefix(_.get(child_page, 'stackbit_url_path', null))} className="docs-item-link">{_.get(child_page, 'title', null)}<span className="icon-angle-right" aria-hidden="true" /></Link></li>
                                ))}
                              </ul>
                            )}
                          </React.Fragment>);
